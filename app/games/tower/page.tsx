...
export default function TowerGame() {
  ...
  return (
    <GamePageWrapper title="Tower Game">
      <div className="space-y-6">
        {/* Game Info */}
        <div className="bg-[#1a1a2e] rounded-2xl p-4 border border-[#2a2a45]">
          <div className="text-center space-y-2">
            <h2 className="text-white font-bold text-xl">Tower</h2>
            <p className="text-[#8888aa] text-sm">Climb the tower and win big!</p>
          </div>
        </div>
        ...
        <div className="bg-[#1a1a2e] rounded-2xl p-6 border border-[#2a2a45] min-h-[300px] flex items-center justify-center">
          <div className="text-center space-y-4">
            <div className="w-20 h-20 bg-gradient-to-br from-[#1a6ef5] to-[#0d4bc4] rounded-full mx-auto flex items-center justify-center">
              <span className="text-white font-bold text-2xl">🏔️</span>
            </div>
            <p className="text-white font-bold text-lg">Ready to Climb?</p>
            <p className="text-[#8888aa] text-sm">Select your bet amount and play</p>
          </div>
        </div>
