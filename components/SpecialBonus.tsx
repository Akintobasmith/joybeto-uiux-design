export default function SpecialBonus() {
  return (
    <div className="mx-3.5 my-3 bg-gradient-to-br from-[#2a0a5a] to-[#4a1a9a] rounded-3.5 p-3.25 flex items-center gap-2.5 border border-[#5a2aaa] my-2.5">
      ...
      <div className="flex-1">
        ...
        <div className="text-[#f5a623] text-sm font-black">BONUS </div>
      </div>
