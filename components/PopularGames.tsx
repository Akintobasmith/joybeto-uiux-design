  ...
  return (
    <div>
      ...
      <div className="px-3.5 grid grid-cols-2 gap-2.5 mb-3">
        {games.map((game) => (
          <div key={game.id} className="bg-[#141428] rounded-[13px] overflow-hidden border border-[#2a2a48]">
            {/* Game Header */}
            ...
            {/* Play Button */}
            <button className="mx-2 mb-2 w-[calc(100%-1rem)] px-2 py-1.5 bg-gradient-to-br from-[#1a6ef5] to-[#0d4bc4] border-none rounded-[7px] text-white text-[10px] font-bold cursor-pointer hover:opacity-90">
              ▶ Play Now
            </button>
          </div>
        ))}
